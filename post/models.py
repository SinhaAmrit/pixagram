...
class Post(models.Model):
    ...
    picture = models.ImageField(
        upload_to=user_directory_path, verbose_name="Pictures", null=True
    )
...
class Likes(models.Model):
    ...
    # def user_disliked_post(sender, instance, *args, **kwargs):
    #     like = instance
    #     post = like.post
    #     sender = like.user
    #     notify = Notification.objects.filter(
    #         post=post, sender=sender, notification_types=1
    #     )
    #     notify.delete()
...
class Follow(models.Model):
    ...
    #     following = follow.following
    #     notify = Notification.objects.filter(
    #         sender=sender, user=following, notification_types=3
    #     )
    #     notify.delete()
...
# post_delete.connect(Likes.user_disliked_post, sender=Likes)
